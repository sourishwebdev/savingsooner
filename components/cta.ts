...
export const lightCtaClass = `inline-flex w-full items-center justify-center rounded-buttons bg-iris-pulse px-24 py-16 text-body text-cloud-white shadow-cta transition-[background-color,transform] duration-150 hover:bg-iris-veil hover:-translate-y-px active:bg-iris-glow active:translate-y-0 sm:w-auto ${focusRing} disabled:cursor-not-allowed disabled:bg-iris-shadow disabled:text-fog disabled:shadow-none disabled:hover:translate-y-0`;
